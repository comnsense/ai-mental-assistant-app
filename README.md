...
## Благодарности
Благодарност към всички потребители, които тестваха приложението и предоставиха ценна обратна връзка, както и към научния ръководител за подкрепата и насоките по време на разработката.
